...
export const en = {
  ...
  demo: {
    ...
    turnsNote: 'This demo allows up to 10 conversations per page visit.',
    turnsLeft: '{n} conversations left in this visit',
    turnsExhausted: "You have used this demo visit's 10 conversations. Reopen the page to try again, or create your own reflection for unlimited conversations.",
