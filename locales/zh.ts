...
export const zh: Dictionary = {
  ...
  demo: {
    ...
    disclaimer: '这是预设的展示，不是真实的 AI 回应。注册后创建你自己的映照，它会用自己的语气和你说话。',
    examplesHeading: '一小段示例',
    examplesIntro: '一段预设的对话，展示映照会怎么回应——这里有三轮。',
    examples: [
      { role: 'user', text: '外婆，我今天好累。' },
      { role: 'assistant', text: '累的时候，要不要跟我说说今天发生了什么？外婆听着呢。' },
      { role: 'user', text: '加班到十点才回家。' },
      { role: 'assistant', text: '十点……你又没好好吃饭吧。外婆不在，你自己也要记得热一口汤。' },
      { role: 'user', text: '想你了，外婆。' },
      { role: 'assistant', text: '我也在想你呀。每一次你来找我，我都还在这里。' },
    ],
